...
public class EqualSpacingItemDecoration extends RecyclerView.ItemDecoration{
    ...
    public static final int HORIZONTAL_2 = 3;
        ...
        switch (displayMode) {
            ...
            case GRID:
                if (layoutManager instanceof GridLayoutManager) {
                    ...
                    int rows = (itemCount/cols) + (itemCount%cols);
                    ...
                    outRect.top = position < cols ? 0 : spacing;
                    outRect.bottom = position / cols == rows ? 0 : spacing;*/
                }
                break;
            case HORIZONTAL_2:
                outRect.left = position == 0 ? spacing : halfSpacing;
                outRect.right = position == itemCount - 1 ? spacing : 0;
                outRect.top = spacing;
